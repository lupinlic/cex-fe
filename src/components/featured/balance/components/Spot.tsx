...
export default function SpotView() {
  ...
  const assets = useMemo(() => {
    ...
    return balances.spot.map((item: SpotItem) => {
  ...
  return (
    <div className="min-h-screen p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-lg font-semibold">Tài khoản Spot</h1>
            ...
            {filteredAssets.length === 0 ? (
              ...
              filteredAssets.map((a) => (
                ...
                >
                  ...
                  <td className="p-4">{a.balance.toFixed(4)}</td>
                  <td className="p-4">{a.available.toFixed(4)}</td>
                  <td className="p-4">{a.locked.toFixed(4)}</td>
