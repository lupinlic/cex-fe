    ...
    <div className="grid grid-cols-2 min-h-screen">
      ...
      <div className="bg-background text-foreground flex flex-col justify-center items-center p-10">
        ...
        <p className="text-muted-foreground max-w-md mb-10 text-center">
          Tạo tài khoản để bắt đầu giao dịch tiền mã hóa một cách an toàn,
      ...
      <div className="flex items-center justify-center bg-background">
        <div className="w-[400px]">
          ...
          {/* Email */}
          <Input placeholder="Email" className="mb-4 py-5" />

          {/* Password */}
          <Input type="password" placeholder="Mật khẩu" className="mb-4 py-5" />
