...
interface FutureTradingDataState {
  latestBlock: number;
...
export const useFutureTradingStore = create<FutureTradingDataState>((set) => ({
  ...
  summary: { totalBalance: "50000", unrealizedPnL: "1250", totalMargin: "25000" },
  setSummary: (data) => set({ summary: data }),
}));

export const useFutureTradingData = () => useFutureTradingStore();
